...
echo ("<FONT SIZE=4><CENTER>Перелік нормативних документів.</CENTER></FONT><hr>");
...
echo ("<td valign='top'><B>$res2[typ]</B></td><td valign='top'><B>$res2[nomernakazu]</B></td>");
$nazva=urlencode("$res2[nazva]");
echo ("<td valign='top'><a href=detalnormativni.php?nazva=$nazva>$res2[nazva]</a></td></tr>");
}
echo ("</table>");
