...
echo ("<a href='normativni.php' target='superblock'>Повернутися до переліку документів...</a><br><hr>");
...
{
$nazvarozdilu3=urlencode("$res2[nazvarozdilu]");
$nazva3=urlencode($nazva);
echo ("<a href=text.php?nazvarozdilu=$nazvarozdilu3&nazva=$nazva3>$res2[nazvarozdilu]</a><br><br>"); 
}

echo ("<hr>Остання дата внесення змін до системи: $res[time]<br><br>");
 
#echo ("</table><br><br>");
echo ("<a href='normativni.php' target='superblock'>Повернутися до переліку документів...</a>");
mysql_close($dbcnx);
?>
