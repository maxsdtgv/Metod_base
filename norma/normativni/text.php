...
$zapros = mysql_query("SELECT pidrozdil FROM normativna where nazva='$nazva' AND nazvarozdilu='$nazvarozdilu'");
$res = mysql_fetch_array($zapros);
$nazva2=urlencode($nazva);
echo ("<a href=detalnormativni.php?nazva=$nazva2 target='superblock'>Повернутися до переліку статей ...</a><br><br>");
echo ("<B>$nazva<br><br>");
